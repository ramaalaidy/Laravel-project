        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ml-auto d-none d-md-block d-md-flex">
            ...
            <div class="media header-top-info">
              ...
              <div class="media-body">
                <p>Have any question?</p>
                <p>Free: <a href="tel:+12 365 5233">wadi-rum@gmail.com</a></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav">
              ...
              <li class="nav-item"><a class="nav-link" href="properties.html">booking</a></li>
      ...
      <div class="row align-items-center">
        <div class="col-lg-5 mb-4 mb-lg-0">
          <div class="row no-gutters welcome-images">
            <div class="col-sm-7">
              <div class="card">
                <img class="" src="img/home/16.jpg" alt="Card image cap">
              </div>
            </div>
            <div class="col-sm-5">
              <div class="card">
                <img class="" src="img/home/12.jpg" alt="Card image cap">
              </div>
            </div>
            <div class="col-lg-12">
              <div class="card">
                <img class="" src="img/home/11.jpg" alt="Card image cap">
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-7">
          <div class="welcome-content">
            <h2 class="mb-4"><span class="d-block">Welcome</span> to our Wadi Rum</h2>
            <p>Discover the breathtaking landscapes of Wadi Rum, where towering sandstone mountains meet endless golden dunes. Immerse yourself in the authentic Bedouin culture, explore ancient petroglyphs, and witness the stunning night sky filled with countless stars. </p>
            <p>From thrilling jeep safaris to peaceful camel rides, every moment in Wadi Rum is an unforgettable adventure. Enjoy luxury camping under the stars, savor traditional Bedouin cuisine, and embrace the tranquility of the desert.</p>
  ...
  <section class="section-padding bg-porcelain">
    <div class="container">
      <div class="section-intro text-center pb-80px">
        ...
        <h2>Special Facilities in Wadi Rum </h2>
      </div>
      <div class="special-img mb-30px">
        {{-- <img class="img-fluid" src="img/home/17.jpg" alt=""> --}}
      </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card card-special">
            <div class="media align-items-center mb-1">
              ...
              <div class="media-body">
                <h4 class="card-special__title">Desert Meeting & Event Space 
                </h4>
              </div>
            </div>
            <div class="card-body">
              <p>Host your gatherings in the heart of Wadi Rum, surrounded by breathtaking desert landscapes. 
                </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card card-special">
            <div class="media align-items-center mb-1">
              ...
              <div class="media-body">
                <h4 class="card-special__title">Desert Oasis – Natural Pools in Wadi Rum 
                </h4>
              </div>
            </div>
            <div class="card-body">
              <p>While Wadi Rum is a vast desert with golden dunes and towering rock formations, some luxury camps offer artificial swimming pools for a refreshing escape from the desert heat.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card card-special">
            <div class="media align-items-center mb-1">
              ...
              <div class="media-body">
                <h4 class="card-special__title">Desert Adventure Club – Wadi Rum 
                </h4>
              </div>
            </div>
            <div class="card-body">
              <p>Experience the thrill of adventure in Wadi Rum’s vast desert playground.</p>
            </div>
          </div>
        </div>
      </div>
